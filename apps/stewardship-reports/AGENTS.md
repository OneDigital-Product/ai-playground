# Agents Guide — apps/stewardship-reports

This guide is scoped to the `apps/stewardship-reports` Next.js 15 app.
...
- Dev: `pnpm --filter stewardship-reports dev`
- Build: `pnpm --filter stewardship-reports build`
- Lint: `pnpm --filter stewardship-reports lint`
- Type check: `pnpm --filter stewardship-reports check-types`
